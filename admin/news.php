...
<form action="admin/news1.php" method="post" class="form-horizontal" >
  <h1 style="text-align:center;"> <strong>Enter News</strong></h1>
</br>
</br>
  <textarea class="form-control" rows="9" id="comment" placeholder="Please Update news from here !"></textarea>
</br>
</br>
