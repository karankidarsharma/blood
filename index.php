...
<form name="form1" id="form1" method="post" onsubmit="return validateForm();" action="index1.php" >
...
<div class="w3-content w3-section" style="max-width:600px; ">
  ...
  <img class="mySlides w3-animate-fading" src="image/d1.jpg" style="width:600px; height:300px;">
  <img class="mySlides w3-animate-fading" src="image/d2.jpg" style="width:600px; height:300px;">
  <img class="mySlides w3-animate-fading" src="image/d3.jpg" style="width:600px; height:300px;">
  <img class="mySlides w3-animate-fading" src="image/d4.jpg" style="width:600px; height:300px;">
</br>
...
<h2>Helping to save lives by donating blood</h2>
...
<div class="div5 responsive">
  <h2>Thanks to Donar</h2>
  <p style="color:black;">
<img class="img-rounded" src="image/5.jpg">
</br>
</br>
<p style="color:black;"> 
