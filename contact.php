...
<form  id="form1"  action="register1.php" method="post" onsubmit="return validateForm();" class="form-horizontal">
  ...
  <textarea class="form-control" rows="9" id="comment" value="" placeholder="We love to hear from you !"></textarea>
